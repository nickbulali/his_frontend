      ...
      <td colspan="4">
        <table>
          <tr>
            ...
            <td>
              Invoice Number: {{ data.number }}<br> Date: {{ data.date }}<br> Due Date: {{ data.due_date }}
            </td>
          </tr>
        </table>
      </td>
      ...
      <td colspan="4">
        <table>
          <tr>
             ...
             <td>
              Patient Name: {{data.patient.name.text }}<br> Patient Identifier: {{ data.patient.identifier }}<br>Patient Birth Date: {{ data.patient.birth_date }}<br>Gender: {{  }}
            </td>
          </tr>
        </table>
      </td>
