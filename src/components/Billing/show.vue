                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td>
                                    Patient Name: {{data.patient.name.text }}
                                    <br> Patient Identifier: {{ data.patient.identifier }}
                                    <br>Patient Birth Date: {{ data.patient.birth_date }}
                                    <br>Gender: {{ }}
                                </td>
                            </tr>
                        </table>
