									...
									<v-timeline align-top dense>
										...
										>
											<v-layout pt-1>
												...
												<v-flex xs4>
													<v-btn depressed class="his_card_button white--text" small title="Edit" color="green" :loading="loading" round @click="">
										...
										>
											...
											<v-layout pt-3>
												...
												<v-flex xs2>
													<v-btn depressed single-line fab small color="brown" @click="patientDetails(item.patient)">
